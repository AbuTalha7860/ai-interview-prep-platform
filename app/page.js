          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <button
                ...
                disabled={loading}
                className={`group relative overflow-hidden rounded-full bg-blue-600 px-8 py-6 text-lg font-semibold text-white transition-all hover:bg-blue-700 ${loading ? "opacity-60 cursor-not-allowed" : ""
                  }`}
              >
                {loading ? (
